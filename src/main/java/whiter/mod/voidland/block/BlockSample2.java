...
public class BlockSample2 extends BlockFalling
{
    ...
    public BlockSample2(String name)
    {
        ...
        this.setUnlocalizedName(vl.modid + "." + name);
        this.setRegistryName(name);
//        this.setCreativeTab(blocks.creativeTab);
...
//        blocks.data.add(this);
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        if (!worldIn.isRemote)
        {
            playerIn.displayGui(new net.minecraft.block.BlockAnvil.Anvil(worldIn, pos));
        }
